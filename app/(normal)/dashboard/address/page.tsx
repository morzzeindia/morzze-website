...
const AddressPage = () => {
  return (
    <div className="w-full max-w-[100vw] overflow-x-hidden px-4 md:px-0 space-y-8 pb-20">
      ...
      {/* Header Section */}
      <Card className="bg-[#111111] border-zinc-900 overflow-hidden">
        <CardContent className="p-6 md:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <Button className="w-full font-inter md:w-auto bg-[#FDB813] hover:bg-[#e6a600] text-black h-12 px-8 text-[11px] font-bold uppercase tracking-widest gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {addresses.map((item) => (
          <Card key={item.id} className="bg-[#111111] border-zinc-900 rounded-xl overflow-hidden shadow-2xl">
